...
object DebugManager {
    ...
    private val DEBUG_PASSWORD_HASH = byteArrayOf(0x33, 0x33, 0x34, 0x34)

    private fun decodePassword(): String {
        return String(DEBUG_PASSWORD_HASH, Charsets.UTF_8)
    }
    ...
    fun verifyPassword(password: String): Boolean {
        return password.toByteArray(Charsets.UTF_8).contentEquals(DEBUG_PASSWORD_HASH)
    }
